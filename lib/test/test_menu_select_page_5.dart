...
import 'package:foodiepass_android/test/test_menu_select_page_6.dart';

class TestMenuSelectPage5 extends StatelessWidget {
  @override
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TestMenuSelectPage6()),
                    );
                  },
...
class MenuItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      shadowColor: recommended ? Colors.redAccent : Colors.black54,
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
