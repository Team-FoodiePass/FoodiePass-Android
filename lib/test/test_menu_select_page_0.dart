...
import 'package:foodiepass_android/test/test_menu_select_page_1.dart';

class TestMenuSelectPage0 extends StatelessWidget {
  @override
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TestMenuSelectPage1()),
                    );
                  },
...
class MenuItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      color: recommended ? Colors.lightBlue[50] : Colors.white,
