...
import 'package:foodiepass_android/test/test_menu_select_page_2.dart';

class TestMenuSelectPage1 extends StatelessWidget {
  @override
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TestMenuSelectPage2()),
                    );
                  },
...
class MenuItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      color: recommended ? Colors.amber[50] : Colors.white,
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
