...
import 'package:foodiepass_android/test/test_menu_select_page_3.dart';

class TestMenuSelectPage2 extends StatelessWidget {
  @override
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TestMenuSelectPage3()),
                    );
                  },
...
class MenuItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      shape: RoundedRectangleBorder(
        side: BorderSide(color: recommended ? Colors.orange : Colors.transparent, width: 2),
