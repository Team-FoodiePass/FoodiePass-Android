...
import 'package:foodiepass_android/test/test_menu_select_page_5.dart';

class TestMenuSelectPage4 extends StatelessWidget {
  @override
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TestMenuSelectPage5()),
                    );
                  },
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: recommended ? 18 : 16,
                          fontWeight: recommended ? FontWeight.bold : FontWeight.normal,
                          color: recommended ? Colors.red : Colors.black,
                        ),
                      ),
                      SizedBox(height: 4),
                      Text(
